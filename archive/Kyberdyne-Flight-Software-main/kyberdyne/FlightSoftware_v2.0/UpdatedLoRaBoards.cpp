...
void Debug::printData(uint32_t enc_time, float* data)
{
    DEBUG_BLOCK({
        ...
        Serial.println("  Time       Time       Lat       Lng       Alt      Temp     Press");
...
void Debug::printGeoFence(bool within, float *startCoords, int checksLeft, float radius, float distance)
{
    DEBUG_BLOCK({
        Serial.println("From geoFence:");
        if(!within)
        {
